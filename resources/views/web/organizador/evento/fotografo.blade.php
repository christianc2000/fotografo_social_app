                ...
                <section class="container px-4 mx-auto py-2">
                    <div class="sm:flex sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">Los fotografos pertenecientes al
                        ...
                        <div class="flex items-center mt-4 gap-x-3">
                            ...
                            <a href="{{ route('organizador.evento.fotografos.agregar', $evento->id) }}"
                                ...
                                <span>Vincular Fotografo al evento</span>
                            </a>
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700"
                                        ...
                                        <tbody
                                            ...
                                            @foreach ($fotografos as $fotografo)
                                                <tr data-tipo="{{ $fotografo->pivot->estado }}">
                                                    ...
                                                    <td class="px-12 py-4 text-sm font-medium whitespace-nowrap">
                                                        ...
                                                        @elseif($fotografo->pivot->estado == \App\Models\Evento::ACEPTADO)
                                                            <div
                                                    ...
                                                    <td class="px-4 py-4 text-sm whitespace-nowrap flex items-center justify-center">
                                                        <div>
                                                            <h4 class="text-gray-700 dark:text-gray-200 text-center">
                                                                @if (isset($fotografo->pivot->fecha_aceptacion))
                                                                    {{ $fotografo->pivot->fecha_aceptacion }}
                                                                @else
                                                                    -
                                                                @endif
                                                            </h4>
                                                    ...
                                                    <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                        <div class="dropdown">
                                                            ...
                                                            <div id="myDropdown" class="dropdown-content">
                                                                <a href="#fotografos"
                                                                    class="hover:bg-gray-200">Perfil</a>
                                                                @if ($fotografo->pivot->estado == \App\Models\Evento::ESPERA)
