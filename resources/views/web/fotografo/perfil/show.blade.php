        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            <label for="biografia"
                                                ...
                                                <textarea id="biografia" name="biografia" rows="4" class="block p-2.5 w-full text-sm bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Escribe tu biografía...">{{ $user->biografia }}</textarea>
                                            <span id="errorbiografia"
                                                class="error-message mt-1 text-sm leading-6 text-pink-600"></span>
                                        </div>
                                        <div class="col-span-6 sm:col-span-4">
                                            <label for="marca"
                                                class="block text-sm font-medium text-gray-700">Marca</label>
                                            <input type="text" name="marca" id="marca" autocomplete="given-name"
                                                value="{{ $user->marca }}"
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                            <span id="errormarca"
                                                class="error-message mt-1 text-sm leading-6 text-pink-600"></span>
                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            ...
                                            <input type="text" name="slogan" id="slogan" autocomplete="given-name"
                                                value="{{ $user->slogan }}"
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                            <span id="errorslogan"
                                                class="error-message mt-1 text-sm leading-6 text-pink-600"></span>
            ...
            <script>
                ...
                btnInformation.addEventListener('click', function() {
                    ...
                    var biografia = getValueWithValidation('biografia', 'Campo requerido');
                    var marca = getValueWithValidation('marca', 'Campo requerido');
                    var slogan = getValueWithValidation('slogan', 'Campo requerido');
                    ...
                    var apiUrl = new URL('/api/fotografo/perfil', window.location.origin);
                    console.log(apiUrl)
                ...
                btnPassword.addEventListener('click', function() {
                    ...
                    var newPassConfirmation = getValueWithValidationPassword('new_password_confirmation',
                        'Campo requerido');
                    var userId = this.dataset.user;
                    var apiUrl = new URL('/api/fotografo/password', window.location.origin);
