    ...
    <section class="py-20 relative z-50">
        <div class="container">
            <div class="mx-auto max-w-2xl sm:text-center">
                <span class="font-medium text-gray-400 tracking-widest">Nuestros precios de plan para fotografos</span>
                        ...
                        <div class="flex flex-col border border-gray-300 rounded-xl overflow-hidden dark:border-gray-700">
                            ...
                            <div class="p-10">
                                ...
                                <div class="flex justify-center">
                                    <a href="{{route('plan.registrar.fotografo',$plan->id)}}"
            ...
            <h5 class="text-center font-medium mt-14">¿Desea los planes para Organizador? <a href="{{route('plan.index')}}"
